...
!   BICARBONATE
      iscl = 3;
      ictype(iscl) = 1;
      val(iscl) = 1.67006e03;!1.67702e03;
      np = nnz+2;
      zt = 0;
      bnd(:,iscl) = znptobnd(zt,np);
!   CARBONATE
      iscl = 4;
      ictype(iscl) = 1;
      val(iscl) = 3.14655e02;!3.09065e02;
      np = nnz+2;
      zt = 0;
      bnd(:,iscl) = znptobnd(zt,np);
!   BORIC ACID
      iscl = 5;
      ictype(iscl) = 1;
      val(iscl) = 2.96936e02;!2.88057e02;
      np = nnz+2;
      zt = 0;
      bnd(:,iscl) = znptobnd(zt,np);
!   TETRAHYDROXYBORATE
      iscl = 6;
      ictype(iscl) = 1;
      val(iscl) = 1.18909e02;!1.27943e02;
      np = nnz+2;
      zt = 0;
      bnd(:,iscl) = znptobnd(zt,np);
!   HYDROGEN ION
      iscl = 7;
      ictype(iscl) = 1;
      val(iscl) =6.30928e-03;! 4.324599e-03;
      np = nnz+2;
      zt = 0;
      bnd(:,iscl) = znptobnd(zt,np);
!   HYDROXIDE
