! ============================================================================ !
! ABOUT:                                                                       !
!         This subroutine computes means for all variables used in iso,        !
!         surfvis, comp1, and compmn.                                          !
! ============================================================================ !
!
...
!
! SAVE MEANS AND DIVERGENCE FOR PRINTOUT AND COMPMN, CPUS HAVE MEANS OVER ALL Z
  IF (istage .EQ. 1) THEN
    DO iz=izs,ize
      izm1 = iz - 1
      DO iy=iys,iye
        DO ix=1,nnx
          divz(iz) = divz(iz) + (ux(ix,iy,iz)+vy(ix,iy,iz)  &
