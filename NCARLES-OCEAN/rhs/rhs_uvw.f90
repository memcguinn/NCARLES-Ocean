! ============================================================================ !
! ABOUT:                                                                       !
!         This subroutine gets the RHS of (u,v,w) equations for pencil size    !
!         (nnx, iys:iye, izs:ize).                                             !
! ============================================================================ !
!
...
!
    ...
    REAL :: fnt1(nnx,iys:iye), fnt2(nnx,iys:iye),       &
            fnt3(nnx,iys:iye), fnt4(nnx,iys:iye),       &
            tau13_u(nnx,iys:iye), tau23_u(nnx,iys:iye), &
            tau13_l(nnx,iys:iye), tau23_l(nnx,iys:iye), &
            r3_sum(1:nnz)
!
! --------------------------------------------------------------------------- !
!
...
!
    ...
    END IF
!
!   X AND Z HORIZONTAL SGS FLUXES FOR U,V,W,TAU_11,TAU_12,TAU_13,TAU_23 AT IZ
    DO iy=iys,iye
      DO ix=1,nnx
...
!
  ...
  END DO
!
! SGS FLUXES TAU_12,TAU_22,TAU_23 THAT DEPEND ON Y-DERIVATIVES
  DO iz=izs,ize
    izm1 = iz - 1
    DO iy=iys,iye
      DO ix=1,nnx
