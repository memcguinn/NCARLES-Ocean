...
!
    ...
    REAL ::  ug(maxnz),vg(maxnz),                   &
             wls(maxnz),uls(maxnx)
    REAL ::  udrift,vdrift,cpou10,                  &
             stokess,stokes(maxnz1),f2w,ann,grav_w,sigma_p,bnn,z_pt
    REAL ::  dtg, dslg, dzg
    END TYPE con_s
!
    ...
    REAL, POINTER ::                                             &
                 ug(:), vg(:), wls(:), uls(:)
    REAL, POINTER ::                                                &
                 udrift, vdrift, cpou10,                    &
                 stokess, stokes(:),f2w,ann,grav_w,sigma_p,bnn,z_pt
    REAL, POINTER ::                                             &
                 dtg, dslg, dzg
!
    CONTAINS
...
!
  SUBROUTINE fill_cs
!
!   POINTER ASSOCIATION FOR STAT ARRAYS, GET SIZE OF STAT ARRAYS, ISIZE, FOR HIST FILES 
    isize = 0
